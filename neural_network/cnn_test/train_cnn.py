...
WEIGHTS_PATH = Path("ecg_cnn_weights.pt")
...
def main():
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=0.0002063516079146668, weight_decay=1.081834063388435e-05)
    ...
    if run_training:
        ...
        # 4) Salvataggio pesi
        # --------------------------------------------------------------------
        torch.save(model.state_dict(), "ecg_cnn_weights.pt")
        print("Pesi salvati in ecg_cnn_weights.pt")
    else:
