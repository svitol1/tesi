...
Prima di affrontare il problema del malposizionamento degli elettrodi e le tecniche automatiche per il suo rilevamento, è necessario richiamare le nozioni di base. Questo capitolo introduce in primis l'anatomia del cuore e i meccanismi elettrofisiologici alla base della sua attività, per poi descrivere come tali fenomeni si trasformano nel segnale elettrocardiografico a 12 derivazioni. Successivamente,  saranno approfonditi: il posizionamento standard degli elettrodi, il calcolo delle derivazioni a partire dai potenziali misurati e i criteri con cui si valuta la normalità di un tracciato.
